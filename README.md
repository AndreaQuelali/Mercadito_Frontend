...
| `/home` | Autenticado | Descubrimiento (saludo, destacados, recién llegados) |
| `/products` | Público | Catálogo con búsqueda, filtros y orden |
| `/productos` | Redirect | Compat → `/products` |
